    ...
    function Plugin($container, options) {
        ...
        function _initialize() {
            ...
            if ($dropdownItems.length === 0) {
                var $blankItem = $("<li>&#xd7;</li>");
                $blankItem.attr("data-color", "");
                $blankItem.css("backgroundColor", "#ffffff");
                $dropdown.append($blankItem);
        ...
        this.setColor = function(color, $invokingContainer) {
            ...
            var $myInner = $myColor.find(".colorInner");
            $myInner.css("backgroundColor", self.colorHex);
            $myColor.find(".colorInput").val(self.colorHex);
            $myInner.text(self.colorHex ? " " : "×");
        };
